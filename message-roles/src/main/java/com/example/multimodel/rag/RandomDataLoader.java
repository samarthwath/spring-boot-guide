...
public class RandomDataLoader {
    ...
    public void loadSentencesIntoVectorStore() {
        SearchRequest searchRequest = SearchRequest.builder().topK(1).query("test").build();
        List<Document> emptyDocuments = vectorStore.similaritySearch(searchRequest);
        if (emptyDocuments.isEmpty()) {
            ...
            LOG.info("Random Data loaded at the startup");
        } else {
